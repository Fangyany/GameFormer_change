...
def model_training():
    ...
    valid_path = 'nuplan/processed_data/valid/mini' + '/*.npz'
...
if __name__ == "__main__":
    # num_gpu = torch.cuda.device_count()  # 获取当前可用的GPU的数量
    # print("Device count: {}".format(num_gpu))
        
    # Arguments
    parser = argparse.ArgumentParser(description='Training')
    parser.add_argument('--name', type=str, help='log name (default: "Exp1")', default="Exp2_60")
