...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment_name', default='open_loop_boxes', help='experiment name')
    parser.add_argument('--data_path', type=str, default='nuplan/dataset/nuplan-v1.1/splits/test')
    parser.add_argument('--map_path', type=str, default='nuplan/dataset/maps')
    parser.add_argument('--model_path', type=str, default='training_log/Exp1/model_epoch_20_valADE_2.4798.pth')
